...
INMODULES=0 # set to 1 to include modules in updater zip 
...
KERNEL_SOURCE=https://github.com/RedEnemy30/kernel_xiaomi_positron.git # set to a preferred remote URL (e.g https://github.com/torvalds/linux...)

KBRANCH="-b stage3" # if not changed, use default kernel branch
